...
What is the median station in terms of temperature, wind speed, and atmospheric pressure? Look for the three weather stations that best represent continental U
S using the `quantile()` function. Do these three coincide?
...
```
Answer : No, these three do not coincide. 
...
met_stations[, windsp50s := quantile(wind.sp, probs=0.5, na.rm=TRUE), by = STATE]
